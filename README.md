...
<style>
    .divStyle1{
        width:100%;
        height:100%;
        background: -webkit-radial-gradient(circle,#E6B2FF,#6E77FF,#40A6FF);
        background: -o-radial-gradient(circle,#E6B2FF,#6E77FF,#40A6FF);
        background: -moz-radial-gradient(circle,#E6B2FF,#6E77FF,#40A6FF);
        background: radial-gradient(circle,#E6B2FF,#6E77FF,#40A6FF);
        padding: 10px;
