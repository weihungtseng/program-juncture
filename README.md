...
<style>
    .divStyle1{
        width:100%;
        height:100%;
        background: -webkit-radial-gradient(circle,#00ffff,#8900FF,#00ccff);
        background: -o-radial-gradient(circle,#00ffff,#8900FF,#00ccff);
        background: -moz-radial-gradient(circle,#00ffff,#8900FF,#00ccff);
        background: radial-gradient(circle,#00ffff,#8900FF,#00ccff);
        padding: 10px;
