...
<div style="padding: 10px; background-color: #9ACEEB;">
    ...
    <table style="width: 80%;" align="center">
        ...
        -->
        <tr>
              <td style="width: 20%; height: 10%" align="center" valign="center"> <ve-media class="pictureSize1" anno-base="None/None/" src="gh:weihungtseng/juncture-media/picture/NTNU_School_Badge.png"></ve-media></td>
              <td>
